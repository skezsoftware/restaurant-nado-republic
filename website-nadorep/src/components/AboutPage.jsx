    ...
    <>
      ...
      <section className="description-about">
        ...
        <p>
          ...
          Italian dining experiences in the city. At Nado Republic, our menu and
          atmosphere are constantly evolving, ensuring there is always something
          new and exciting for our guests to enjoy. Whether you’re here for a
          quick bite or a long, leisurely dinner, you’ll find a unique blend of
          experience and delicious food waiting for you.
        </p>
        <br />
        <p>
      ...
      <section>
        {/* <img src={MarilynTable} alt="table" id="about-image"/> */}
      </section>
    </>
  );
}
